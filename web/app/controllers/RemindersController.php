...
class RemindersController extends Controller {
    ...
    {
        return View::make('login.pwdremind')->with('title', t('Password Reset'));
    }
    ...
    public function getReset($token = null)
    {
        ...
        return View::make('login.pwdreset')->with('token', $token)->with('title', t('Password Reset'));
    }
    ...
    public function postReset()
    {
        ...
        switch ($response)
        {
            ...
            case Password::INVALID_USER:
                return Redirect::back()->with('flashError', t('No user exists with this email address'));

            case Password::PASSWORD_RESET:
                return Redirect::to('login')->with('flashSuccess', t('Your password is now updated'));
        }
    }
