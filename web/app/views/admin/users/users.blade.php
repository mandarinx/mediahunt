...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover footable toggle-medium" data-filter="#filter">
        ...
        <tr>
            @endif
            <td><img src="{{ getAvatar($user,50,50) }}" alt=""/></td>
            ...
            @endif
            <td>
                <a class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" data-original-title="Visit Profile" href="{{ route('user',array('username'=>$user->username)) }}">
