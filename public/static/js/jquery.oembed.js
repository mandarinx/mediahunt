...
(function($) {
    ...
    $.fn.oembed.getPhotoCode = function(url, oembedData) {
        ...
        if (oembedData.url){
            code = '<div><a href="' + url + '" target=\'_blank\'><img class="img-responsive img-embed" src="' + oembedData.url + '" alt="' + alt + '"/></a></div>';
        } else if (oembedData.thumbnail_url){
            var newURL = oembedData.thumbnail_url.replace('_s','_b');
            code = '<div><a href="' + url + '" target=\'_blank\'><img class="img-responsive img-embed" src="' + newURL + '" alt="' + alt + '"/></a></div>';
        } else {
                ...
                extraSettings.yql = {from:'json'
                    ...
                    , datareturn:function(results){
                        if (results.json.type != 'video' && (results.json.url || results.json.thumbnail_url)) {
                            return '<img class="img-responsive img-embed" src="' + (results.json.url || results.json.thumbnail_url) + '" />';
                        }
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("dribbble", "photo", ["dribbble.com/shots/.+"], "http://api.dribbble.com/shots/$1?callback=?",
            { templateRegex:/.*shots\/([\d]+).*/,
                templateData : function(data){if(!data.image_teaser_url)return false;
                    return  '<img class="img-responsive img-embed" src="'+data.image_teaser_url+'"/>';
                }
            }),
        ...
        new $.fn.oembed.OEmbedProvider("gravtar", "photo", ["mailto:.+"],null,
            {templateRegex:/mailto:([^\/]+).*/
                ...
                return '<img class="img-responsive img-embed" src="http://gravatar.com/avatar/'+email.md5()+'.jpg" alt="on Gravtar" class="jqoaImg">';
            }
            }),
        ...
        new $.fn.oembed.OEmbedProvider("livejournal", "rich", ["livejournal.com/"], "http://ljpic.seacrow.com/json/$2$4?jsonp=?"
            ,{templateRegex:/(http:\/\/(((?!users).)+)\.livejournal\.com|.*users\.livejournal\.com\/([^\/]+)).*/,
                templateData : function(data){if(!data.username)return false;
                    return  '<div><img class="img-responsive img-embed" src="'+data.image+'" align="left" style="margin-right: 1em;" /><span class="oembedall-ljuser"><a href="http://'+data.username+'.livejournal.com/profile"><img class="img-responsive img-embed" src="http://www.livejournal.com/img/userinfo.gif" alt="[info]" width="17" height="17" /></a><a href="http://'+data.username+'.livejournal.com/">'+data.username+'</a></span><br />'+data.name+'</div>';
                }
            }),
        ...
        new $.fn.oembed.OEmbedProvider("facebook", "rich", ["facebook.com/(people/[^\\/]+/\\d+|[^\\/]+$)"], "https://graph.facebook.com/$2$3/?callback=?"
            ,{templateRegex:/.*facebook.com\/(people\/[^\/]+\/(\d+).*|([^\/]+$))/,
                templateData : function(data){ if(!data.id)return false;
                    ...
                    if(data.picture) out += '<a href="'+data.link+'"><img class="img-responsive img-embed" src="'+data.picture+'"></a>';
                    else out += '<img class="img-responsive img-embed" src="https://graph.facebook.com/'+data.id+'/picture">';
            ...
            {yql:{xpath:"//meta|//title|//link", from:'html'
                , datareturn:function(results){
                    ...
                    if(results['og:video']) {
                        ...
                        var img = $('<img class="img-responsive img-embed" src="'+results['og:image']+'">');
